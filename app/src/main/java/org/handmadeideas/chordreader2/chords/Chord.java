...
public class Chord implements Cloneable, Serializable {
	...
	public Object clone() {
		...
		org.handmadeideas.chordreader2.chords.Chord clonedChord = new org.handmadeideas.chordreader2.chords.Chord();
	...
	public static org.handmadeideas.chordreader2.chords.Chord newChord(ChordRoot root, ChordQuality quality, ChordExtended seventh,
																	   ChordAdded added, ChordSuspended suspended, ChordRoot overridingRoot) {
		
		org.handmadeideas.chordreader2.chords.Chord chord = new org.handmadeideas.chordreader2.chords.Chord();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		org.handmadeideas.chordreader2.chords.Chord other = (org.handmadeideas.chordreader2.chords.Chord) obj;
		if (added == null) {
			if (other.added != null)
				return false;
