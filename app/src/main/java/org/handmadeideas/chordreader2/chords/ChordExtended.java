package org.handmadeideas.chordreader2.chords;


import java.util.*;

import static org.handmadeideas.chordreader2.chords.ChordQuality.*;
...
public enum ChordExtended {
	...
	public static List<String> getAllAliases() {
		...
		for (org.handmadeideas.chordreader2.chords.ChordExtended chordSeventh : values()) {
	...
	private static Map<String, org.handmadeideas.chordreader2.chords.ChordExtended> lookupMap = new HashMap<String, org.handmadeideas.chordreader2.chords.ChordExtended>();
	
	static {
		for (org.handmadeideas.chordreader2.chords.ChordExtended value : values()) {
	...
	public static org.handmadeideas.chordreader2.chords.ChordExtended findByAlias(String alias) {
