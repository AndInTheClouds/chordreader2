...
public enum ChordAdded {
	...
	public static List<String> getAllAliases() {
		...
		for (org.handmadeideas.chordreader2.chords.ChordAdded chordAdded : values()) {
	...
	private static Map<String, org.handmadeideas.chordreader2.chords.ChordAdded> lookupMap = new HashMap<String, org.handmadeideas.chordreader2.chords.ChordAdded>();
	
	static {
		for (org.handmadeideas.chordreader2.chords.ChordAdded value : values()) {
	...
	public static org.handmadeideas.chordreader2.chords.ChordAdded findByAlias(String alias) {
