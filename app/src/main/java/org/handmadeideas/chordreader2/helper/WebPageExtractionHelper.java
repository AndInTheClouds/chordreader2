...
import org.handmadeideas.chordreader2.ChordWebpage;
...
public class WebPageExtractionHelper {
	...
	private static UtilLogger log = new UtilLogger(org.handmadeideas.chordreader2.helper.WebPageExtractionHelper.class);
